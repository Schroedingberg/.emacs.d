* TODO Migrate uncatogorized or custom set preferences <2016-03-19 Sat>
  :LOGBOOK:
...
* Dotemacs
  Settings that are specific to the strategy of organizing the initfile as an org file.
  #+begin_src emacs-lisp :tangle yes
